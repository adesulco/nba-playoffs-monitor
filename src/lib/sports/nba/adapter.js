 ...
 * rest of usePlayoffData / useFuturesOddsWS / api.js into this module is
 ...
 *
 * The actual data hooks (useLivePlayoffs, useFuturesOddsWS, etc.) continue to
...
function prerenderRoutes() {
  const out = [
    {
      ...
      title: 'Skor NBA Playoffs 2026 — Bracket Live | gibol.co',
      description: 'Skor NBA Playoffs 2026 live: bracket Ronde 1, win probability, play-by-play, shot chart, statistik pemain, watchlist.',
      keywords: 'skor nba, skor basket, skor playoff nba, skor nba live, skor nba hari ini, bracket nba playoff 2026, jadwal nba playoff, nba playoff 2026 indonesia, live nba indonesia',
      ogImage: HUB_OG,
      jsonLd: [
        PLAYOFFS_JSONLD,
        breadcrumbSchema([
  ...
  for (const t of teams()) {
    out.push({
      ...
      description: `Skor live ${t.name} (${t.abbr}) NBA Playoff 2026: jadwal, statistik pemain. Star: ${t.star}.`,
      keywords: `skor ${t.nickname.toLowerCase()}, skor ${t.abbr.toLowerCase()}, ${t.nickname.toLowerCase()} playoff, jadwal ${t.nickname.toLowerCase()}, ${t.name.toLowerCase()}, nba playoff 2026`,
