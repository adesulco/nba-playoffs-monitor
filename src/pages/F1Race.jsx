...
export default function F1Race() {
  ...
  // Catatan Race — if the race is already past, a 1200×630 recap PNG exists
  // at /og/f1/2026-R{nn}-{slug}-og.png (generated by scripts/generate-f1-recap.mjs
  // and committed to public/). We wire it as og:image so a WhatsApp/Twitter
  // share of the race URL previews with the podium card instead of the
  // generic site OG. Fallback: SEO component's default og-image.
  const todayISO = new Date().toISOString().slice(0, 10);
  const isPast = gp.dateISO <= todayISO;
  const recapOgUrl = isPast
    ? `https://www.gibol.co/og/f1/2026-R${String(gp.round).padStart(2, '0')}-${gp.slug}-og.png`
    : null;
